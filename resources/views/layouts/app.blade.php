...
<header class="app-header navbar">
    ...
    <a class="navbar-brand" href="#">
        <img class="navbar-brand-full" src="{{asset('img/coin.jpg')}}" width="100" height="30"
             alt="InfyOm Logo">
        <img class="navbar-brand-minimized" src="{{asset('img/coin.jpg')}}"   width="100" height="30" alt="InfyOm Logo">
    </a>
...
<footer class="app-footer">
    <div>
        <a href="https://infyom.com">Developed Information Systems Unit </a>
        <span>&copy; 2020 ISU.</span>
    </div>
